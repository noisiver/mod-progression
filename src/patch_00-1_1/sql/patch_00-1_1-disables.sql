DELETE FROM `disables` WHERE `sourceType` = 1 AND `entry` IN (550, 3631, 4487, 4488, 4489, 4490, 6145, 6521, 6522, 7028, 7029, 7041, 7044, 7064, 7065, 7066, 7067, 7068, 7070, 7441, 7481, 7482, 7492, 7494, 7562, 7638, 7670, 8181, 8922, 8923, 10955, 11123, 11124, 11130, 11172, 11211, 11214, 11215, 11481, 11482, 11497, 11498, 11880, 13830, 13832, 13833, 13834, 13836, 13861, 13862, 13863, 13864, 14016, 14100, 14111);
