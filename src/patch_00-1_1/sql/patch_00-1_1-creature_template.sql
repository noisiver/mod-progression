...
UPDATE `creature_template` SET `HealthModifier` = 15 WHERE `entry` IN (17543, 17546, 17547, 18806, 21246, 21863, 22848, 22849, 22881, 22885, 23580, 23774);
UPDATE `creature_template` SET `HealthModifier` = 5 WHERE `entry` IN (11391, 11388, 11387, 17548, 21865, 23047, 25268);
