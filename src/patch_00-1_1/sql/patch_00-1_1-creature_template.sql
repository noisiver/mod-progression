...
UPDATE `creature_template` SET `difficulty_entry_1` = 0, `minlevel` = 61, `maxlevel` = 61, `exp` = 0, `DamageModifier` = 15, `BaseAttackTime` = 2500, `RangeAttackTime` = 1265, `unit_class` = 1, `lootid` = @lootId+4, `maxgold` = 9694, `HealthModifier` = 16 WHERE `entry` = 16020;
UPDATE `creature_template` SET `difficulty_entry_1` = 0, `minlevel` = 62, `maxlevel` = 62, `exp` = 0, `DamageModifier` = 30.6, `BaseAttackTime` = 2500, `RangeAttackTime` = 3700, `lootid` = @lootId+5, `maxgold` = 9706 WHERE `entry` = 16021;
UPDATE `creature_template` SET `difficulty_entry_1` = 0, `minlevel` = 60, `maxlevel` = 60, `exp` = 0, `DamageModifier` = 14.95, `BaseAttackTime` = 2500, `RangeAttackTime` = 1265, `unit_class` = 1, `lootid` = @lootId+6, `maxgold` = 9796, `HealthModifier` = 14, `ManaModifier` = 2 WHERE `entry` = 16022;
...
UPDATE `creature_template` SET `minlevel` = 61, `maxlevel` = 61, `exp` = 0, `DamageModifier` = 4.35 WHERE `entry` = 16027;
UPDATE `creature_template` SET `difficulty_entry_1` = 0, `minlevel` = 63, `maxlevel` = 63, `exp` = 0, `DamageModifier` = 67.5, `RangeAttackTime` = 1700, `lootid` = @lootId+7, `HealthModifier` = 1200 WHERE `entry` = 16028;
...
UPDATE `creature_template` SET `difficulty_entry_1` = 0, `minlevel` = 60, `maxlevel` = 60, `exp` = 0, `DamageModifier` = 23, `BaseAttackTime` = 1800, `RangeAttackTime` = 1265, `HealthModifier` = 50 WHERE `entry` = 16375;
UPDATE `creature_template` SET `difficulty_entry_1` = 0, `minlevel` = 62, `maxlevel` = 62, `exp` = 0, `DamageModifier` = 0.05, `RangeAttackTime` = 1551, `HealthModifier` = 1.1 WHERE `entry` = 16385;
