...
UPDATE `creature_template` SET `difficulty_entry_1` = 0, `minlevel` = 61, `maxlevel` = 61, `exp` = 0, `DamageModifier` = 15, `BaseAttackTime` = 2500, `RangeAttackTime` = 1265, `unit_class` = 1, `maxgold` = 9694, `HealthModifier` = 16 WHERE `entry` = 16020;
UPDATE `creature_template` SET `difficulty_entry_1` = 0, `minlevel` = 62, `maxlevel` = 62, `exp` = 0, `DamageModifier` = 30.6, `BaseAttackTime` = 2500, `RangeAttackTime` = 3700, `maxgold` = 9706 WHERE `entry` = 16021;
UPDATE `creature_template` SET `difficulty_entry_1` = 0, `minlevel` = 60, `maxlevel` = 60, `exp` = 0, `DamageModifier` = 14.95, `BaseAttackTime` = 2500, `RangeAttackTime` = 1265, `unit_class` = 1, `maxgold` = 9796, `HealthModifier` = 14, `ManaModifier` = 2 WHERE `entry` = 16022;
