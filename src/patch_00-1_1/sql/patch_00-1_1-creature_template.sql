...
UPDATE `creature_template` SET `HealthModifier` = 50 WHERE `entry` IN (16151, 16152, 17521, 18836, 18835, 18832, 18834, 22953, 22956, 22964, 23049);
...
UPDATE `creature_template` SET `HealthModifier` = 25 WHERE `entry` IN (17533, 17534, 17535, 17897, 17898, 18168, 20031, 20033, 20034, 20036, 20037, 20042, 20047, 20048, 20052, 21220, 21224, 21225, 21226, 21227, 21228, 21229, 21230, 21231, 21232, 21298, 21299, 21301, 21339, 22945, 22965, 23403, 23421);
...
UPDATE `creature_template` SET `HealthModifier` = 30 WHERE `entry` IN (17818, 22845, 22846, 22847, 22853, 22869, 22874, 22875, 22876, 22877, 22879, 22882, 22959, 23028, 23235, 23236, 23237, 23339, 23374, 23400, 23402);
UPDATE `creature_template` SET `HealthModifier` = 35 WHERE `entry` IN (17864, 21218, 21221, 22960, 23018, 23030, 23172, 23330, 25363, 25367, 25368, 25369, 25370, 25371, 25373, 25483, 25484, 25486, 25506, 25509, 25591, 25597, 25837);
UPDATE `creature_template` SET `HealthModifier` = 20 WHERE `entry` IN (17895, 21806, 23215, 23232, 24374, 24549, 25867);
...
UPDATE `creature_template` SET `HealthModifier` = 500 WHERE `entry` IN (18805, 21215, 21217, 22887);
...
UPDATE `creature_template` SET `HealthModifier` = 475 WHERE `entry` IN (24850, 25165, 25166);
