...
UPDATE `creature_template` SET `HealthModifier` = 40 WHERE `entry` IN (17256, 19389, 19389, 20032, 20035, 20041, 20045, 20046, 20049, 20050, 21350, 22873, 23337, 23397, 25592);
...
UPDATE `creature_template` SET `HealthModifier` = 5 WHERE `entry` IN (11391, 11388, 11387, 17548, 17902, 17903, 21865, 23047, 25268);
