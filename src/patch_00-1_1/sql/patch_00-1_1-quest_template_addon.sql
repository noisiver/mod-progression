UPDATE `quest_template_addon` SET `AllowableClasses` = `AllowableClasses` &~ 8 | 4 WHERE `ID` IN (9054, 9055, 9056, 9057, 9058, 9059, 9060, 9061);
UPDATE `quest_template_addon` SET `AllowableClasses` = `AllowableClasses` | 64 WHERE `ID` IN (9068, 9069, 9070, 9071, 9072, 9073, 9074, 9075);
UPDATE `quest_template_addon` SET `AllowableClasses` = `AllowableClasses` &~ 128 | 8 WHERE `ID` IN (9077, 9078, 9079, 9080, 9081, 9082, 9083, 9084, 9126);
