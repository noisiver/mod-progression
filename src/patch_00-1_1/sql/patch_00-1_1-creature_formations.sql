...
DELETE FROM `creature_formations` WHERE `leaderGUID` IN (128067, 128068, 128070, 128072, 128073, @creatureId+3);
...
(128068, 128068, 0, 0, @noFollowLeader, 0, 0, 0, 16),
(128068, 128069, 0, 0, @noFollowMember, 0, 0, 0, 16),
(128068, @creatureId+16, 0, 0, @noFollowMember, 0, 0, 0, 16),
(128068, @creatureId+17, 0, 0, @noFollowMember, 0, 0, 0, 16),
