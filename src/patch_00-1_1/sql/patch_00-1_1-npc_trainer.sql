...
DELETE FROM `npc_trainer` WHERE `ID` = 200004 AND `SpellID` IN (25290, 25291, 25292, 25782, 25894, 25898, 25899, 25916, 25918, 31789, 62124);
DELETE FROM `npc_trainer` WHERE `ID` = 200006 AND `SpellID` IN (1066, 21849, 21850, 25297, 25298, 25299, 26991, 31018, 31709);
DELETE FROM `npc_trainer` WHERE `ID` = 200008 AND `SpellID` IN (23028, 25304, 25306, 25345, 27090, 27127, 28609, 28612, 33717);
DELETE FROM `npc_trainer` WHERE `ID` = 200010 AND `SpellID` IN (1710, 23161, 25307, 25309, 25311, 28610);
DELETE FROM `npc_trainer` WHERE `ID` = 200012 AND `SpellID` IN (21562, 21564, 25314, 25315, 25316, 25392, 27683, 39374);
