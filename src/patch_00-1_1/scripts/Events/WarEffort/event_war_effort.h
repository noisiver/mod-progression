...
private:
    ...
    uint32 events[MAX_EVENTS][MAX_EVENT_COLUMNS] = {
        { EVENT_WAR_EFFORT_RESOURCE_COLLECTION, STAGE_RESOURCE_COLLECTION, STAGE_TRANSITION_DAY_5, PATCH_THE_GATES_OF_AHN_QIRAJ },
        { EVENT_WAR_EFFORT_COMMENDATION_OFFICERS, STAGE_RESOURCE_COLLECTION, STAGE_ATTACK_ON_CENARION_HOLD, PATCH_THE_GATES_OF_AHN_QIRAJ },
        { EVENT_WAR_EFFORT_DAY_1, STAGE_TRANSITION_DAY_1, STAGE_ATTACK_ON_CENARION_HOLD, PATCH_THE_GATES_OF_AHN_QIRAJ },
        { EVENT_WAR_EFFORT_DAY_2, STAGE_TRANSITION_DAY_2, STAGE_ATTACK_ON_CENARION_HOLD, PATCH_THE_GATES_OF_AHN_QIRAJ },
        { EVENT_WAR_EFFORT_DAY_3, STAGE_TRANSITION_DAY_3, STAGE_ATTACK_ON_CENARION_HOLD, PATCH_THE_GATES_OF_AHN_QIRAJ },
        { EVENT_WAR_EFFORT_DAY_4, STAGE_TRANSITION_DAY_4, STAGE_ATTACK_ON_CENARION_HOLD, PATCH_THE_GATES_OF_AHN_QIRAJ },
        { EVENT_WAR_EFFORT_DAY_5, STAGE_TRANSITION_DAY_5, STAGE_ATTACK_ON_CENARION_HOLD, PATCH_THE_GATES_OF_AHN_QIRAJ },
        { EVENT_WAR_EFFORT_GATE, STAGE_RESOURCE_COLLECTION, STAGE_BANG_A_GONG },
        { EVENT_WAR_EFFORT_GONG, STAGE_BANG_A_GONG, STAGE_ATTACK_ON_CENARION_HOLD, PATCH_THE_GATES_OF_AHN_QIRAJ, PATCH_WORLD_OF_WARCRAFT },
        { EVENT_WAR_EFFORT_RESONATING_CRYSTALS, STAGE_GATE_IS_OPEN, STAGE_ATTACK_ON_CENARION_HOLD, PATCH_THE_GATES_OF_AHN_QIRAJ },
        { EVENT_WAR_EFFORT_ATTACK_ON_CENARION_HOLD, STAGE_ATTACK_ON_CENARION_HOLD, STAGE_ATTACK_ON_CENARION_HOLD, PATCH_THE_GATES_OF_AHN_QIRAJ }
    };
};
