...
class boss_gluth_progression : public CreatureScript
{
public:
    boss_gluth_progression() : CreatureScript("boss_gluth") { }

    CreatureAI* GetAI(Creature* pCreature) const override
    {
        return GetNaxxramasAI<boss_gluth_progressionAI>(pCreature);
    }

    struct boss_gluth_progressionAI : public BossAI
    {
        explicit boss_gluth_progressionAI(Creature* c) : BossAI(c, BOSS_GLUTH), summons(me)
        {
