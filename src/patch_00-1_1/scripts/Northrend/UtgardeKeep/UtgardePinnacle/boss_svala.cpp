...
class boss_svala_progression : public CreatureScript
{
public:
    boss_svala_progression() : CreatureScript("boss_svala") { }

    CreatureAI* GetAI(Creature* creature) const override
    {
        return GetUtgardePinnacleAI<boss_svala_progressionAI>(creature);
    }

    struct boss_svala_progressionAI : public ScriptedAI
    {
        boss_svala_progressionAI(Creature* creature) : ScriptedAI(creature), summons(me)
        {
