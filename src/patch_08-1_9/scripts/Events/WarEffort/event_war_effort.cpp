...
{
    if (resources[RESOURCE_COPPER_BARS_ALLIANCE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_COPPER_BARS_ALLIANCE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_IRON_BARS][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_IRON_BARS][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_THORIUM_BARS][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_THORIUM_BARS][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_STRANGLEKELP][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_STRANGLEKELP][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_PURPLE_LOTUS_ALLIANCE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_PURPLE_LOTUS_ALLIANCE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_ARTHAS_TEARS][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_ARTHAS_TEARS][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_LIGHT_LEATHER][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_LIGHT_LEATHER][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_MEDIUM_LEATHER][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_MEDIUM_LEATHER][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_THICK_LEATHER_ALLIANCE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_THICK_LEATHER_ALLIANCE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_LINEN_BANDAGE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_LINEN_BANDAGE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_SILK_BANDAGE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_SILK_BANDAGE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_RUNECLOTH_BANDAGE_ALLIANCE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_RUNECLOTH_BANDAGE_ALLIANCE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_RAINBOW_FIN_ALBACORE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_RAINBOW_FIN_ALBACORE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_ROAST_RAPTOR][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_ROAST_RAPTOR][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_SPOTTED_YELLOWTAIL_ALLIANCE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_SPOTTED_YELLOWTAIL_ALLIANCE][COLUMN_RESOURCE_REQUIRED_AMOUNT])
    {
        teamFinished[TEAM_ALLIANCE] = true;
    }
    
    if (resources[RESOURCE_TIN_BARS][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_TIN_BARS][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_MITHRIL_BARS][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_MITHRIL_BARS][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_COPPER_BARS_HORDE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_COPPER_BARS_HORDE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_PEACEBLOOM][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_PEACEBLOOM][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_FIREBLOOM][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_FIREBLOOM][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_PURPLE_LOTUS_HORDE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_PURPLE_LOTUS_HORDE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_HEAVY_LEATHER][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_HEAVY_LEATHER][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_THICK_LEATHER_HORDE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_THICK_LEATHER_HORDE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_RUGGED_LEATHER][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_RUGGED_LEATHER][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_WOOL_BANDAGE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_WOOL_BANDAGE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_MAGEWEAVE_BANDAGE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_MAGEWEAVE_BANDAGE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_RUNECLOTH_BANDAGE_HORDE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_RUNECLOTH_BANDAGE_HORDE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_LEAN_WOLF_STEAK][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_LEAN_WOLF_STEAK][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_SPOTTED_YELLOWTAIL_HORDE][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_SPOTTED_YELLOWTAIL_HORDE][COLUMN_RESOURCE_REQUIRED_AMOUNT] &&
        resources[RESOURCE_BAKED_SALMON][COLUMN_RESOURCE_CURRENT_AMOUNT] == resources[RESOURCE_BAKED_SALMON][COLUMN_RESOURCE_REQUIRED_AMOUNT])
    {
        teamFinished[TEAM_HORDE] = true;
    }
}
