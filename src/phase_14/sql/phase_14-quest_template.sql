UPDATE `quest_template` SET `RewardItem1` = 40752, `RewardAmount1` = 1 WHERE `ID` IN ( -- Emblem of Heroism
    24789, -- Daily Heroic Random (Nth)
    24790 -- Daily Normal Random (1st)
);
UPDATE `quest_template` SET `RewardItem1` = 40753, `RewardAmount1` = 2 WHERE `ID` = 24788; -- Daily Heroic Random (1st) -> Emblem of Valor
UPDATE `quest_template` SET `RewardItem1` = 40753 WHERE `ID` IN ( -- Emblem of Valor
