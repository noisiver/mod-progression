...
class boss_onyxia_progression : public CreatureScript
{
public:
    boss_onyxia_progression() : CreatureScript("boss_onyxia") {}
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_SPELL_FIREBALL_FIRST:
                {
                    ...
                    events.ScheduleEvent(EVENT_SPELL_FIREBALL_SECOND, 3s);
                    break;
                }
                ...
                case EVENT_PHASE_3_ATTACK:
                {
                    ...
                    events.ScheduleEvent(EVENT_SUMMON_WHELP, 5s);
                    break;
                }
    ...
    {
        return GetOnyxiasLairAI<boss_onyxia>(creature);
    };
};

void AddSC_boss_onyxia_progression()
{
    new boss_onyxia_progression();
}
