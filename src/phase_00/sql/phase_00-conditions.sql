...
SET @lootId := 46000;
DELETE FROM `conditions` WHERE `SourceTypeOrReferenceId` = 15 AND `SourceGroup` IN (4117, 4122, 4123, 4126, 4127, 4128, 4129, 4131, 4132, 4133, 4134, 4201) AND `SourceEntry` = 0;
