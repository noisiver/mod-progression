...
SET @lootId := 46000;
DELETE FROM `conditions` WHERE `SourceTypeOrReferenceId` = 1 AND `SourceGroup` = @lootId AND `SourceEntry` IN (18422, 18423, 21108);
...
(1, @lootId+0, 21108, 0, 0, 9, 0, 8620, 0, 0, 0, 0, 0, '', NULL); -- Onyxia - Draconic for Dummies Chapter IV
