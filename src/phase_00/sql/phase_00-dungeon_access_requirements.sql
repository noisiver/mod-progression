DELETE FROM `dungeon_access_requirements` WHERE `dungeon_access_id` IN (29, 32, 47, 64);
...
(32, 1, 10445, 'You must complete the quest "The Vials of Eternity" before entering The Battle for Mount Hyjal.', 2, NULL, 0, 'The Battle for Mount Hyjal'),
(47, 2, 31704, 'You must have The Tempest Key in your inventory before entering The Eye.', 2, NULL, 0, 'The Eye'),
