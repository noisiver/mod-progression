DELETE FROM `disables` WHERE `sourceType` = 1 AND `entry` IN (7441, 7492, 7494, 8800, 8286, 8556, 8557, 8558, 8689, 8690, 8691, 8692, 8693, 8694, 8695, 8696, 8697, 8698, 8699, 8700, 8701, 8702, 8703, 8704, 8705, 8706, 8707, 8708, 8709, 8710, 8711, 8712, 8922, 8923, 9023, 11481);
