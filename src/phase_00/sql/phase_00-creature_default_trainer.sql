...
UPDATE `creature_default_trainer` SET `TrainerId` = @TrainerId+12 WHERE `CreatureId` IN (
...
UPDATE `creature_default_trainer` SET `TrainerId` = @TrainerId+13 WHERE `CreatureId` IN (
...
UPDATE `creature_default_trainer` SET `TrainerId` = @TrainerId+14 WHERE `CreatureId` IN (
...
UPDATE `creature_default_trainer` SET `TrainerId` = @TrainerId+15 WHERE `CreatureId` IN (
