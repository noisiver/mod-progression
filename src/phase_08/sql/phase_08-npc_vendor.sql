DELETE FROM `npc_vendor` WHERE `entry` = 18525 AND `item` IN (29266, 29267, 29268, 29269, 29270, 29271, 29272, 29273, 29274, 29275, 29367, 29368, 29369, 29370, 29373, 29374, 29375, 29376, 29379, 29381, 29382, 29383, 29384, 29385, 29386, 29387, 29388, 29389, 29390, 30761, 30762, 30763, 30764, 30766, 30767, 30768, 30769, 30770, 30772, 30773, 30774, 30776, 30778, 30779, 30780, 32083, 32084, 32085, 32086, 32087, 32088, 32089, 32090);
INSERT INTO `npc_vendor` (`entry`, `slot`, `item`, `maxcount`, `incrtime`, `ExtendedCost`, `VerifiedBuild`) VALUES
(18525, 0, 29266, 0, 0, 1037, 0), -- Azure-Shield of Coldarra
...
(18525, 0, 29271, 0, 0, 1015, 0), -- Talisman of Kalecgos
...
(18525, 0, 29369, 0, 0, 1015, 0), -- Shawl of Shifting Probabilities
