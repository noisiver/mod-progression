...
UPDATE `creature_onkill_reputation` SET `MaxStanding1`=6 WHERE `creature_id` IN (
...
UPDATE `creature_onkill_reputation` SET `MaxStanding1`=7 WHERE `creature_id` IN (
...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1`=5 WHERE `creature_id` IN (
    11338, -- Hakkari Shadowcaster
    11339, -- Hakkari Shadow Hunter
    11340, -- Hakkari Blood Priest
    11351, -- Gurubashi Headhunter
...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1`=10 WHERE `creature_id` IN (
...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1`=30 WHERE `creature_id` IN (
    1847, -- Foulmane
    10821, -- Hed'mush the Rotting
    10825, -- Gish the Unmoving
    10826, -- Lord Darkscythe
...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1`=40 WHERE `creature_id` IN (
    10738 -- High Chief Winterfall
);

UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1`=50 WHERE `creature_id` IN (
...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1`=100 WHERE `creature_id` IN (
...
UPDATE `creature_onkill_reputation` SET `MaxStanding2`=7 WHERE `creature_id` IN (
...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue2`=10 WHERE `creature_id` IN (
...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue2`=300 WHERE `creature_id` IN (
    15340, -- Moam
    15348, -- Kurinnaxx
...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue2`=600 WHERE `creature_id` IN (
    15339 -- Ossirian the Unscarred
);

UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue2`=1000 WHERE `creature_id` IN (
    15727 -- C'Thun
);
