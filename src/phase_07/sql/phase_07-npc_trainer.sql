...
DELETE FROM `npc_trainer` WHERE `ID` = 1246; -- Vosur Brakthel <Apprentice Alchemist>
...
DELETE FROM `creature_default_trainer` WHERE `CreatureId` = 1246; -- Vosur Brakthel <Apprentice Alchemist>
