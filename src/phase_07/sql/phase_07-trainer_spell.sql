...
DELETE FROM `trainer_spell` WHERE `TrainerId` = @TrainerId+4 AND `SpellId` IN (19801, 25294, 25295, 25296, 27014, 27016, 27019, 27021, 27022, 27023, 27025, 27044, 27045, 27046, 27065, 27067, 27068, 34026, 34074, 34477, 34600, 36916, 56641, 60051, 63668, 63669, 63670);
...
(@TrainerId+10, 25590, 79000, 0, 0, 20777, 0, 0, 69, 0), -- Ancestral Spirit (Rank 6)
...
(@TrainerId+10, 57720, 3400, 0, 0, 30706, 0, 0, 60, 0), -- Totem of Wrath (Rank 2)
