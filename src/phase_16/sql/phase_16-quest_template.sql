UPDATE `quest_template` SET `RewardItem1` = 40753 WHERE `ID` = 24788; -- Daily Heroic Random (1st) -> Emblem of Triumph
UPDATE `quest_template` SET `RewardItem1` = 45624 WHERE `ID` IN ( -- Emblem of Conquest
