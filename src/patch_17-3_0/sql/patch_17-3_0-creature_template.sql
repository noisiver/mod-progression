...
UPDATE `creature_template` SET `difficulty_entry_1`=29373, `minlevel`=83, `maxlevel`=83, `exp`=2, `DamageModifier`=35, `BaseAttackTime`=2000, `lootid`=15931, `HealthModifier`=210 WHERE `entry`=15931; -- Grobbulus
UPDATE `creature_template` SET `difficulty_entry_1`=29417, `minlevel`=83, `maxlevel`=83, `exp`=2, `DamageModifier`=35, `lootid`=15932, `HealthModifier`=200 WHERE `entry`=15932; -- Gluth
UPDATE `creature_template` SET `difficulty_entry_1`=29371, `name`='Stitched Giant', `minlevel`=83, `maxlevel`=83, `exp`=2, `DamageModifier`=7.5, `BaseAttackTime`=2000, `lootid`=100003, `HealthModifier`=16 WHERE `entry`=16025; -- Stitched Spewer (Stitched Giant)
UPDATE `creature_template` SET `difficulty_entry_1`=29324, `minlevel`=83, `maxlevel`=83, `exp`=2, `DamageModifier`=35, `lootid`=16028, `HealthModifier`=310 WHERE `entry`=16028; -- Patchwerk
UPDATE `creature_template` SET `difficulty_entry_1`=29359, `minlevel`=82, `maxlevel`=82, `exp`=2, `DamageModifier`=7.5, `BaseAttackTime`=2000, `lootid`=100003 WHERE `entry`=16021; -- Living Monstrosity
UPDATE `creature_template` SET `difficulty_entry_1`=29356, `minlevel`=82, `maxlevel`=82, `exp`=2, `DamageModifier`=7.5, `lootid`=100003, `HealthModifier`=10 WHERE `entry`=16029; -- Sludge Belcher
UPDATE `creature_template` SET `difficulty_entry_1`=29347, `minlevel`=81, `maxlevel`=81, `exp`=2, `DamageModifier`=7.5, `BaseAttackTime`=2000, `lootid`=100003, `HealthModifier`=11 WHERE `entry`=16017; -- Patchwork Golem
UPDATE `creature_template` SET `difficulty_entry_1`=29353, `minlevel`=81, `maxlevel`=81, `exp`=2, `DamageModifier`=7.5, `BaseAttackTime`=2000, `lootid`=100003, `HealthModifier`=13.5 WHERE `entry`=16018; -- Bile Retcher
UPDATE `creature_template` SET `difficulty_entry_1`=29362, `minlevel`=81, `maxlevel`=81, `exp`=2, `DamageModifier`=7.5, `BaseAttackTime`=2000, `lootid`=100003, `HealthModifier`=6 WHERE `entry`=16020; -- Mad Scientist
UPDATE `creature_template` SET `difficulty_entry_1`=29363, `minlevel`=80, `maxlevel`=80, `exp`=2, `DamageModifier`=7.5, `BaseAttackTime`=2000, `lootid`=100003, `HealthModifier`=2.5 WHERE `entry`=16022; -- Surgical Assistant
UPDATE `creature_template` SET `minlevel`=81, `maxlevel`=81, `exp`=2, `DamageModifier`=7.5 WHERE `entry`=16027; -- Living Poison
UPDATE `creature_template` SET `difficulty_entry_1`=29827, `minlevel`=80, `maxlevel`=80, `exp`=2, `DamageModifier`=7.5 WHERE `entry`=16419; -- Ghost of Naxxramas
UPDATE `creature_template` SET `difficulty_entry_1`=29355, `minlevel`=80, `maxlevel`=80, `exp`=2, `DamageModifier`=7.5, `BaseAttackTime`=2000, `HealthModifier`=1.6 WHERE `entry`=16024; -- Embalming Slime
UPDATE `creature_template` SET `difficulty_entry_1`=30303, `minlevel`=80, `maxlevel`=80, `exp`=2, `BaseAttackTime`=2000 WHERE `entry`=16360; -- Zombie Chow
UPDATE `creature_template` SET `minlevel`=82, `maxlevel`=82, `exp`=2, `lootid`=0, `AIName`='' WHERE `entry`=16368; -- Necropolis Acolyte
UPDATE `creature_template` SET `difficulty_entry_1`=29354, `minlevel`=80, `maxlevel`=80, `exp`=2, `DamageModifier`=7.5, `BaseAttackTime`=2000, `HealthModifier`=8 WHERE `entry`=16375; -- Sewage Slime
UPDATE `creature_template` SET `lootid`=0, `AIName`='' WHERE `entry`=16449; -- Spirit of Naxxramas
UPDATE `creature_template` SET `DamageModifier`=7.5, `lootid`=0, `AIName`='' WHERE `entry`=16448; -- Plagued Deathhound
UPDATE `creature_template` SET `difficulty_entry_1`=30097, `minlevel`=81, `maxlevel`=81, `exp`=2, `speed_walk`=0.8, `DamageModifier`=7.5, `lootid`=100003, `HealthModifier`=8 WHERE `entry`=16447; -- Plagued Ghoul
UPDATE `creature_template` SET `name`='[UNUSED] Death Knight Vindicator', `exp`=1, `speed_walk`=2.2, `DamageModifier`=40, `BaseAttackTime`=1000, `lootid`=0, `AIName`='' WHERE `entry`=16451; -- Deathknight Vindicator
UPDATE `creature_template` SET `exp`=1, `speed_walk`=1, `DamageModifier`=26, `BaseAttackTime`=1200, `unit_class`=1, `lootid`=0, `ScriptName`='' WHERE `entry`=16452; -- Necro Knight Guardian
UPDATE `creature_template` SET `difficulty_entry_1`=29446, `minlevel`=83, `maxlevel`=83, `exp`=2, `DamageModifier`=35, `BaseAttackTime`=2000, `HealthModifier`=60 WHERE `entry`=15929; -- Stalagg
UPDATE `creature_template` SET `difficulty_entry_1`=29447, `minlevel`=83, `maxlevel`=83, `exp`=2, `DamageModifier`=35, `BaseAttackTime`=2000, `HealthModifier`=60 WHERE `entry`=15930; -- Feugen
UPDATE `creature_template` SET `difficulty_entry_1`=29448, `minlevel`=83, `maxlevel`=83, `exp`=2, `DamageModifier`=35, `BaseAttackTime`=2000, `lootid`=15928, `HealthModifier`=275 WHERE `entry`=15928; -- Thaddius
*/
