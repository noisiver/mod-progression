UPDATE `gameobject` SET `phaseMask` = 1 WHERE `id` IN (190683, 190684, 190697, 190698, 190699, 190704, 190710, 190711, 190712, 193981);
...
DELETE FROM `gameobject` WHERE `id` IN (176146, 176147, 176148, 181476);
