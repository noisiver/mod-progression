...
UPDATE `item_template` SET `Quality` = 4, `stat_value1` = 11, `stat_type2` = 6, `stat_value2` = 8, `spellid_1` = 15714, `DisenchantID` = 65 WHERE `entry` = 19426;
UPDATE `item_template` SET `Quality` = 4, `stat_value1` = 19, `stat_value2` = 10, `stat_type3` = 4, `stat_value3` = 10, `DisenchantID` = 65 WHERE `entry` = 19491;
