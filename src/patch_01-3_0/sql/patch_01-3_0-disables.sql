DELETE FROM `disables` WHERE (`sourceType`=1 AND `entry` IN (6145, 6521, 6522, 13830, 13832, 13833, 13834, 13836, 14100, 14111)) OR (`sourceType`=2 AND `entry` IN (249, 603, 631, 632, 649, 650, 658, 668, 724)) OR (`sourceType`=3 AND `entry` IN (6, 30, 32)) OR (`sourceType`=9 AND `entry` IN (26, 51, 54, 61, 63, 64)) OR (`sourceType`=10 AND `entry`=50289);
