...
inline std::vector<std::string> Progression::GetActivePatches()
{
    ...
    if (Id >= PATCH_FURY_OF_THE_SUNWELL)
    ...
    if (Id == PATCH_ASSAULT_ON_THE_RUBY_SANCTUM)
