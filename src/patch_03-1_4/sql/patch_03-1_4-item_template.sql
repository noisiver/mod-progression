...
UPDATE `item_template` SET `Quality` = 3, `armor` = 43, `spellid_1` = 21618, `spelltrigger_1` = 1, `DisenchantID` = 49 WHERE `entry` = 13386;
UPDATE `item_template` SET `Quality` = 3, `armor` = 202, `spellid_1` = 21596, `spelltrigger_1` = 1, `RandomProperty` = 933, `DisenchantID` = 49 WHERE `entry` = 13387;
UPDATE `item_template` SET `Quality` = 3, `stat_value1` = 22, `armor` = 445, `shadow_res` = 10, `DisenchantID` = 49 WHERE `entry` = 14537;
UPDATE `item_template` SET `Quality` = 3, `stat_value1` = 19, `stat_value2` = 9, `armor` = 66, `spellid_1` = 9413, `spelltrigger_1` = 1, `DisenchantID` = 49 WHERE `entry` = 14538;
UPDATE `item_template` SET `Quality` = 3, `StatsCount` = 5, `stat_value1` = 6, `stat_value2` = 30, `stat_type4` = 5, `stat_value4` = 6, `stat_type5` = 3, `stat_value5` = 5, `armor` = 141, `DisenchantID` = 49 WHERE `entry` = 14539;
UPDATE `item_template` SET `Quality` = 3, `armor` = 152, `spellid_1` = 21627, `spelltrigger_1` = 1, `DisenchantID` = 49 WHERE `entry` = 14545;
UPDATE `item_template` SET `Quality` = 3, `stat_value1` = 13, `stat_type3` = 7, `stat_value3` = 8, `armor` = 274, `spellid_1` = 9315, `spelltrigger_1` = 1, `DisenchantID` = 49 WHERE `entry` = 14548;
